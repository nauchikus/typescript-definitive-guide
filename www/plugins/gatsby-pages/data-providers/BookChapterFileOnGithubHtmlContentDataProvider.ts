...
export class BookChapterFileOnGithubHtmlContentDataProvider extends BaseFileOnGithubHtmlContentDataProvider<BookChapterFileOnGithubHtmlContentGetDataParams>{
  ...
  async getData (params:BookChapterFileOnGithubHtmlContentGetDataParams): Promise<ResultData> {
