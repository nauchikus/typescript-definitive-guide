...
export type PdfSharedLocalization = AppLocalization["layouts"]["shared"]["pdf"];
...
export type PdfPageLocalization = AppLocalization["pages"]["pdf"];
export type PdfPageGuiLocalization = PdfPageLocalization["gui"];
