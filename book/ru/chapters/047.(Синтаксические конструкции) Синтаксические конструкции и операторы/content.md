...
Несмотря на то, что существует способ получать только необходимые значения, это не решит проблему семантики кода, поскольку идентификатор переменной является частью мозаики иллюстрирующей работу логики. И хотя в _TypeScript_, эту проблему можно решить и другими способами, они не чем не смогут помочь скомпилированному в _JavaScript_ коду.
