...
Обобщенное программирование, позволяет разработчикам, таких языков, как например _C#_, _Java_, _F#_, _Scala_, сокращать количество преобразований (приведения), писать многократно используемый код и при этом повышать его типобезопасность.
...
-   _классов_ (`class`), в том числе _классовым выражениям_ (class expression)
